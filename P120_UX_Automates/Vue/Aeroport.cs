...
///Auteur : Kaeno Eyer
///Date : 25.04.2024
///Description : Code de la Vue de la page Aéroport
///
using System;
...
namespace P120_UX_Automates.Vue
{
    public partial class Aeroport : Form
    {
        ...
        /// <summary>
        /// Met à jour la langue dans la page Aéroport
        /// </summary>
        /// <param name="RMANAGER">Langue séléctionnée</param>
        ...
        private void btnValid_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                _tickets = new Tickets(lblAeroport.Text,WhichType(), _price, dateTime.Value.ToString(), _nbDays);
                Debug.WriteLine(dateTime.Value.ToString());
