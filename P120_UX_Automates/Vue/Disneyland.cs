...
///Auteur : Kaeno Eyer
///Date : 25.04.2024
///Description : Code de la Vue de la page DisneyLand
///
using System;
...
namespace P120_UX_Automates.Vue
{
    public partial class Disneyland : Form
    {
        ...
        /// <summary>
        /// Met à jour la langue dans la page Disneyland
        /// </summary>
        ...
        /// <summary>
        /// Vérifie si l'user à tout sélectionné, si oui, il l'enregistre et envoie un msg de confirmation
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void btnValid_Click(object sender, EventArgs e)
        {
            if (WhichType() == "" || coboxQuantity.Text == "" || _nbDays == 0)//Vérifie si le client a bien sélectionné les éléments nécéssaires
            {
                MessageBox.Show("Veuillez séléctionner toutes les options", "Attention");
            }
            else
            {
                //Définit le prix avant de créer le ticket
                WhichType();

                _tickets = new Tickets(lblDisney.Text, WhichType(), _price, dateTime.Value.ToString(), _nbDays);
